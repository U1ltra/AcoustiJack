...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="/home/jiaruili/Documents/exp/gzFolMe/20250222-182559-dist1_gimbal_3/strongsort/imgs")
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    for sequence in sequences:
        ...
        for i in range(1,len(pictures)):
            if "." not in pictures[i]:
                continue
            if i > 0 and "." not in pictures[i-1]:
                continue
